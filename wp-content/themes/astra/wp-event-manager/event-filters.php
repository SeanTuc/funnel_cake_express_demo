...
<?php $serverInfo = $_SERVER['REQUEST_URI']; ?>
<!-- add to iffs to check if on ghost kitchen page  && strpos($serverInfo, "ghost") == false              -->
...
<form class="wpem-main wpem-form-wrapper wpem-event-filter-wrapper event_filters" id="event_filters">
	...
	<?php do_action( 'event_manager_event_filters_search_events_start', $atts ); ?>
		 <div class="wpem-row">
			...
			<?php if ( $datetimes && strpos($serverInfo, "ghost") == false) : ?>	
