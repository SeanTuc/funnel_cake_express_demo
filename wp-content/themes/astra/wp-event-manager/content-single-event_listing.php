    ...
    <div class="wpem-main wpem-single-event-page">
        ...
        <?php else: ?>
            <?php if (is_event_cancelled()): ?>
                <!--  ********************************************************************* custom remove canceled warning ********************************************************
                    ...
                    <div class="wpem-row">
                                                            ...
                                                            <div class="wpem-col-12 wpem-additional-info-block-group">
                                                                ...
                                                                <?php foreach ($field_value as $child_index => $child_value) : ?>
                                                                    ...
                                                                    <?php foreach ($field['fields'] as $child_field_name => $child_field) : ?>
                                                                        ...
                                                                        <?php if( !empty($child_value[$child_field_name]) ) : ?>
                        ...
                        <div class="wpem-col-xs-12 wpem-col-sm-5 wpem-col-md-4 wpem-single-event-right-content">
                            <div class="wpem-single-event-body-sidebar">
                                ...
                                /* ***************************************************remove event registration option****************************************************************************
                                ...
                                */
                                ...
                                <div class="wpem-single-event-sidebar-info">
                                    ...
                                    <?php 
                                    /**************************** Custom code  *************************************************/
                                    $test_array = json_encode(get_event_category(),true);
                                    if(strpos($test_array, "ghost") !== false){
                                    ...
                                    <?php } ?>
                                     <!-- end of if to remove date and time-->
                                    ...
                                    <?php if (get_option('event_manager_enable_event_types') && get_event_type() && strpos($test_array, "ghost") == false) : ?>
                                        <div class="clearfix">&nbsp;</div>
                                        <h3 class="wpem-heading-text"><?php _e('Event Type', 'wp-event-manager'); ?></h3>
                                        <div class="wpem-event-type"><?php display_event_type(); ?></div>
                                    <?php endif; ?>

                                    <?php if (get_option('event_manager_enable_categories') && get_event_category() && strpos($test_array, "ghost") !== false) : ?>
                                        <div class="clearfix">&nbsp;</div>
