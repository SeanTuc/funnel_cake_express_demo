    ...
    <div class="wpem-event-layout-wrapper">
        <div <?php event_listing_class(''); ?>>
            <a href="<?php display_event_permalink(); ?>" class="wpem-event-action-url event-style-color <?php echo $event_type; ?>">
                    ...
                    <div class="wpem-event-banner-img" style="background-image: url(<?php echo $thumbnail ?>)">
                        ...
                        <div class="wpem-event-date">
                            <div class="wpem-event-date-type">
                                <?php
                                if (!empty($start_date) && strpos($test_array, "ghost") == false)
                                {
                                    ?>
                ...
                <!--------------------------------------- custom hide for ghost kitchen ----------------------------->
                                           
                <div class="wpem-event-infomation">
                    <div class="wpem-event-date">
                        <div class="wpem-event-date-type">
                            <?php
                            if (!empty($start_date) && strpos($test_array, "ghost") == false) /** added in ghost check */
                            {
                                ?>
                                <div class="wpem-from-date">
                                    <div class="wpem-date"><?php echo date_i18n('d', strtotime($start_date)); ?></div>
                            ...
                            <?php
                            if ($start_date != $end_date && !empty($end_date) && strpos($test_array, "ghost") == false) /** added in ghost check */
                            {
                                ?>
