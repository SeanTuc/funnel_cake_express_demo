...
class PrimeMoverValidationHandlers
{
     ...
     * Constructor
     */
    public function __construct(PrimeMover $prime_mover, $utilities = [], PrimeMoverValidationUtilities $validation_utilities) 
    {
     ...
     * @return boolean
     */
    private function isValidJson($input_data = '')
    { 
     ...
     */
    private function analyzeBlogId($sanitized = [], $blog_id = 0)
    {
        if ($blog_id) {
            return $blog_id;
        }
