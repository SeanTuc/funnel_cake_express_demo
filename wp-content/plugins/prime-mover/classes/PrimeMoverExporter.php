...
class PrimeMoverExporter implements PrimeMoverExport
{
     ...
     * @mainsite_compatible
     */
    public function maybeInitializeUserTaxonomy($ret = [], $blogid_to_export = 0, $start_time = 0)
    {
        ...
        $this->getUsersObject()->getUserUtilities()->getUserFunctions()->getUserQueries()->maybeInitializeUserTaxonomies($blogid_to_export, $ret);
        return apply_filters('prime_mover_save_return_export_progress', $ret, $blogid_to_export, $next_func, $current_func);
    }
