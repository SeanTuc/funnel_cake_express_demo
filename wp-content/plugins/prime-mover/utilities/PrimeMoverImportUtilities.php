...
class PrimeMoverImportUtilities
{
    ...
    public function importDoneDialog($blog_id = 0)
    {
        ...
        $this->getSystemCheckUtilities()->getSystemFunctions()->switchToBlog($blog_id);
        $permalinks_page = admin_url('options-permalink.php');
        $this->getSystemCheckUtilities()->getSystemFunctions()->restoreCurrentBlog($blog_id);
        ?>
     ...
     */
    private function analyzeZipPackageDescription($tmp_path = '', $blog_id = 0, $encrypted = false, \ZipArchive $zip, $package_type = '', $blog_id_check = true, $array_type = false)
    {
